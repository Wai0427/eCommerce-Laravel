...
Route::prefix('admin')->name('admin.')->group(function(){
    ...
    Route::middleware(['guest:admin','PreviewBackHistory'])->group(function(){
    ...
    Route::middleware(['auth:admin','PreviewBackHistory'])->group(function(){
        ...
        Route::view('/store','back.pages.store')->name('store');
        Route::view('/insert_product','back.insert_product')->name('insert_product');
    });
