...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
        <!-- add yield function for dynamic page title-->
		...
		<link
			...
			sizes="180x180"
			href="/back/vendors/images/myFavicon4/apple-touch-icon.png"
		/>
		<link
			rel="icon"
			type="image/png"
			sizes="32x32"
			href="/back/vendors/images/myFavicon4/favicon-32x32.png"
		/>
		<link
			rel="icon"
			type="image/png"
			sizes="16x16"
			href="/back/vendors/images/myFavicon4/favicon-16x16.png"
		/>
		...
		<div class="left-side-bar">
			...
			>
				<a href="{{ route('admin.home') }}">
					<img src="/images/users/waiecommerce4.png" alt="" class="dark-logo" style="height:100px;width:100px;" />
					<img
						src="/images/users/waiecommerce3.png"
						alt=""
						class="light-logo"
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="{{ route('admin.store') }}" class="dropdown-toggle no-arrow {{ Route::is('admin.store') ? 'active' : '' }}">
								<span class="micon bi bi-receipt-cutoff"></span
								><span class="mtext">MyStore</span>
							</a>
						</li>
						<li>
							<div class="dropdown-divider"></div>
						...
						<li>
							<a
								href="{{ route('admin.profile') }}?tab=personal_details"
						...
						<li>
							<a
								href="{{ route('admin.settings') }}?tab=general_settings"
		...
		<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
                    ...
                    <!-- Our main page content will be inside this yield function -->
					<div>
                        @yield('content')
                    </div>
				</div>
				<div class="footer-wrap pd-20 mb-20 card-box">
					Waiecomlarav By
					<a href="https://github.com/Wai0427" target="_blank"
						>Chen Weng Wai</a
					>
				</div>
			</div>
...
<script>
	window.addEventListener('showToastr', function(event){
		...
		@livewireScripts
        <!-- add this stack directive for custom scripts -->
		@stack('scripts')
	</body>
</html>
